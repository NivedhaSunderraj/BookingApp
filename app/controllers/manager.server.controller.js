var Manager = require('mongoose').model('Manager'),passport = require('passport');
...
exports.create = function(req, res, next) {
    ...
    var user = new User({"username":req.body.username,"password":req.body.password,"type" : req.body.type,"provider": "local"});
